...
public class MissionService {
    ...
    public User completeMission(CompleteMissionForm form) throws Exception {
        ...
        if (optionalUser.isPresent()){
            ...
            writeBoardMission3(form, user);
            writeBoardMission2(form, user);
            writeBoardMission1(form, user);
    ...
    private void writeBoardMission3(CompleteMissionForm form, User user) throws Exception {
    ...
    private void writeBoardMission2(CompleteMissionForm form, User user){
    ...
    private void writeBoardMission1(CompleteMissionForm form, User user){
